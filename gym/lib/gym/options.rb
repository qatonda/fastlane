    ...
    def self.plain_options
      [
        ...
        FastlaneCore::ConfigItem.new(key: :analyze_build_time,
                                     ...
                                     optional: true,
                                     type: Boolean),
          FastlaneCore::ConfigItem.new(key: :arch_options,
                                     env_name: "GYM_ARCH_OPTIONS",
                                     description: "If specified 'arch [options]' will be included before the xcodebuild command. Used to support running xcode",
                                     optional: true),
